                ...
                <Col md={8}>
                  <div className="restaurant-detailed-header-left">
                    ...
                    <p className="text-white mb-1">
                      <Icofont icon="location-pin" /> 36, Gokhle Road, Gandhi
                      Nagar, Kurla(E)<Badge variant="success">OPEN</Badge>
                    </p>
          ...
          <section className="offer-dedicated-body pt-2 pb-2 mt-4 mb-4">
            <Container>
              <Row>
                        ...
                        <Row>
                          ...
                          <Col md={4} sm={6} className="mb-4">
                            <BestSeller
                              id={1}
                              title="World Famous"
                              subTitle="North Indian â¢ American â¢ Pure veg"
                              imageAlt="Product"
                      ...
                      <Tab.Pane eventKey="third">
                        ...
                        >
                          ...
                          <p className="mb-2 text-black">
                            ...
                            iamdishco@gmail.com, dishcoeat@gmail.com
                          </p>
                          <p className="mb-2 text-black">
                ...
                <Col md={4}>
                  <div className="bg-light rounded shadow-sm mb-4 p-4 dishco-cart-item">
                    <div className=" mb-4 p-2 bg-white">
                      <h5 className="mb-1 ">Your Order</h5>
